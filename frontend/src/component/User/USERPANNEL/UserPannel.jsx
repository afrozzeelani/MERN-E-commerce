        ...
        <div className="container">
          ...
          <div className="row">
            <div style={{border:'1px solid rgba(212, 203, 203, 0.188)', minHeight:'80vh', maxHeight:'80vh'}} className="col-3 rounded px-4 py-3 ">
              ...
              <div className="row">
                <Link to='/account' style={{boxShadow:'-3px 3px 5px rgba(212, 203, 203, 0.588), 2px -1px 5px rgba(212, 203, 203, 0.388)'}} className="col-12 d-flex justify-between p-2 mb-1 rounded">
